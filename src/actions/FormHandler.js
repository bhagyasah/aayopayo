...
import { signInButtonPressHandler, rememberCheckBoxPressHelper, resetButtonPressHelper } from './helper-functions/signInFormHandler';
  ...
  async (dispatch, getState) => {                                 //eslint-disable-line
    ...
    switch (button) {
      ...
      case 'Submit':
        ...
        break;
      case 'SignIn':
        signInButtonPressHandler(getState(), dispatch, navigation, updateFormValue);
        break;
      case 'ResetPassword':
